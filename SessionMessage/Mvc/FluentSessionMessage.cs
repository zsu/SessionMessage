...
namespace SessionMessages
{
    ...
    {
		private string _imagePath = "/Content/Images/";
            ...
            if(typeof toastr != 'undefined')
                {
				  ...
				  scripts.AppendFormat(@"{0}", options.ToString());
                  scripts.AppendLine(@"messageboxstatusbar.children().each(function() {
...
function displayModalMessage(message) {
    ...
    #messagewrapper .success {
        color: #060;
        background: #cfc url({0}ok.gif) no-repeat 8px 12px !important;
    }

    #messagewrapper .info {
        color: #06f;
        background: #0df url({0}info.gif) no-repeat 8px 12px !important;
    }

    #messagewrapper .warning {
        color: #c60;
        background: #ffc url({0}warn.gif) no-repeat 8px 12px !important;
    }

    #messagewrapper .error {
        color: #c00;
        background: #fcc url({0}fail.gif) no-repeat 8px 12px !important;
    }
...
.ui-dialog-content .messagebox.success {
    background: url({0}ok.gif) no-repeat 8px 12px !important;
    text-align: left;
    padding: 12px 10px 10px 30px !important;
}

.ui-dialog-content .messagebox.info {
    background: url({0}info.gif) no-repeat 8px 12px !important;
    text-align: left;
    padding: 12px 10px 10px 30px !important;
    font-size: 0.85em;
    font-weight: bold;
...
.ui-dialog-content .messagebox.warning {
    background: url({0}warn.gif) no-repeat 8px 12px !important;
    text-align: left;
    padding: 12px 10px 10px 30px !important;
}

.ui-dialog-content .messagebox.error {
    background: url({0}fail.gif) no-repeat 8px 12px !important;
    text-align: left;
    padding: 12px 10px 10px 30px !important;
}
</style>");
			css.Replace("{0}", _imagePath.EndsWith("//")?_imagePath:_imagePath+"//");
			return css.ToString();
		}
